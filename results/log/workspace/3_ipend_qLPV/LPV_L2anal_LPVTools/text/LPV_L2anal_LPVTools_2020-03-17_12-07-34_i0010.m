...
%  Directory: 1_PhD_projects/22_Hinf_norm/LPV_TAC_v2_newmod
...
if LPVTools.lpvnorm_GRID
    ...
    store_results('LPVTools_Results.csv',persist.stamp, x_lim, 0, lpv_gamma, lpvnorm_time, 'tvreal, lpvnorm', 'LFT/IQC', 0)
...
if LPVTools.lpvwcgain_IQC
    ...
    store_results('LPVTools_Results.csv',persist.stamp, x_lim, bounds(1), bounds(2), lpvwcgain_time, 'tvreal, lpvwcgain', 'LFT/IQC', 0)
